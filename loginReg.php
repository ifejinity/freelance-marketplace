...
<div class="container">
    <div class="row">
        <div class="col-md-4 col-md-offset-1" id="registersvg">
            <img src = "image/welcome.svg" alt="SVG" style="width:100%; align-items:center; padding-top:50px"/>
            <img src = "image/signup.svg" alt="SVG" style="width:100%; align-items:center"/>
        </div>
        ...
        <div class="col-md-6 col-md-offset-1" id="loginsvg">
            <img src = "image/login.svg" alt="SVG" style="width:100%; padding-top:50px"/>
        </div>
