	...
	<div class="col-lg-4">
		<div class="jumbotron">
			<div class="container text-center">
				...
				<a href="loginReg.php" class="btn btn-warning btn-lg btnjoin">Join Now</a>
				<p></p>
				<div class="btn-group">
...
<div class="container text-center" style="padding:4%;" id="category">
	<h1 class="card header2" style="background:#007BFF;border-radius:10px">Popular Categories</h1>
	<div class="row">
		<div class="col-lg-4">
...
<div class="container text-center" style="padding:4%;" id="how">
	<h1 class="card header2" style="background:#007BFF;border-radius:10px">How it works</h1>
	<div class="row card" style="padding:30px 60px 30px 60px;margin:30px; border-radius:10px">
		...
		<div class="col-lg-5">
			<img src="image/post.svg" style="width:100%">
		</div>
	</div>
	...
	<div class="row card" style="padding:30px 60px 30px 60px;margin:30px; border-radius:10px">
		...
		<div class="col-lg-5">
		<img src="image/message.svg" style="width:100%">
		</div>
	</div>
	<div class="row card" style="padding:30px 60px 30px 60px;margin:30px;border-radius:10px">
		<div class="col-lg-7">
			<h3>Build a Student client Profile</h3>
		...
		<div class="col-lg-5">
		<img src="image/create.svg" style="width:100%">
		</div>
	</div>
</div>
</div>
...
<div class="container text-center" style="padding:4%;" id="faq">
  ...
  <button type="button" class="btn btn-default btn-lg" data-toggle="collapse" data-target="#demo" style="width:100%;white-space: normal;"><h3>What is Freelance Marketplace?</h3></button>
  ...
  <button type="button" class="btn btn-default btn-lg" data-toggle="collapse" data-target="#demo1" style="width:100%; white-space: normal;"><h3>I am an Employer, how will this site work for me?</h3></button>
  ...
  <button type="button" class="btn btn-default btn-lg" data-toggle="collapse" data-target="#demo2" style="width:100%; white-space: normal;"><h3>I am a Freelancer, how will this site work for me?</h3></button>
  ...
  <button type="button" class="btn btn-default btn-lg" data-toggle="collapse" data-target="#demo3" style="width:100%; white-space: normal;"><h3>Do I have to pay to register?</h3></button>
